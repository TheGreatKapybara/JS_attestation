...
function showItems() {
  ...
  dataSlice.forEach((item) => {
    ...
    const addToEl = fiCatalogItemEl.querySelector(".cart");
    addToEl.dataset.price = item.price
    addToEl.dataset.name = item.name
    addToEl.dataset.img = item.img
    addToEl.dataset.id = item.id
